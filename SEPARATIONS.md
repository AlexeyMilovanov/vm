...
| `specNorm_kronecker` | Forster.lean | spectral norm Kronecker multiplicativity | **proved** modulo two halves `specNorm_kronecker_le` / `le_specNorm_kronecker` (sorry, jules_ready, P6.2) |
| `thresholdDegLE_distThreshold` | DistanceThreshold.lean | `deg±(F_m) ≤ 2` | **proved** (P7.1; `Δ − m/2` quadratic, m odd) |
| `thresholdDeg_distThreshold` | DistanceThreshold.lean | `deg±(F_m) = 2` | sorry (jules_ready P7.2; lower half, cf. `not_thresholdDegLE_one_ndisj`) |
