...
repository you are in) targets the declaration `f8_integer_certificate_margin` in
`HeadComplexity/Separations/EightBitHammingThreshold.lean`; the intended proof is PROOFS.md item
T189.9. The build and the frozen-statement check already
passed. Your job is SEMANTIC review only:
- Read the new/changed proof code (`git diff HEAD` shows the patch, also
  saved at /home/lesha/vm/pipeline_runs/four_results_resume_20260827T200625Z/jules/f8_integer_certificate_margin.patch).
